...
SELECT      continentName, countryName, name, numAttempt, numSuccess, numDns, numDnf,
            TRUNCATE(totTime / 100.0 / 3600, 0) AS numHours
FROM        PersonsView
ORDER BY    numAttempt DESC
LIMIT       10;

-- Top 10 competitors with the highest percentage of DNF for 333
SELECT      continentName, countryName, name, numAttempt333, numSuccess333, numDns333, numDnf333,
